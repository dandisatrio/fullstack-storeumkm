...
@section('title', 'Dashboard Shop Account | Store UMKM Negeri Katon')
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <form action="{{ route('dashboard-shop-account-redirect', 'dashboard-shop-account') }}" method="POST" id="locations" enctype="multipart/form-data">
            @csrf
            <div class="card">
              <div class="card-body">
                <div class="row mb-2">
